...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { font-family: Arial, sans-serif; font-size: 11px; line-height: 1.4; color: #1f2937; padding: 15mm; }
    ...
    h2 { font-size: 14px; font-weight: bold; margin: 15px 0 8px 0; border-bottom: 1px solid #d1d5db; padding-bottom: 4px; }
    .section { margin-bottom: 15px; }
    .grid { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }
    .field { margin-bottom: 8px; }
    .label { font-weight: bold; font-size: 10px; color: #4b5563; }
    .value { font-size: 11px; margin-top: 2px; }
    .signature-section { margin-top: 20px; padding-top: 15px; border-top: 1px solid #d1d5db; }
    .signature-box { border: 1px solid #d1d5db; padding: 10px; min-height: 80px; }
    .qr-container { display: flex; gap: 15px; margin-top: 15px; }
